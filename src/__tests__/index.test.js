...
describe("DeepLinkNow Tests", () => {
    ...
    describe("Initialization Tests", () => {
        it("should initialize successfully", async () => {
            ...
            expect(fetchMock).toHaveBeenCalledWith("https://deeplinknow.com/api/v1/sdk/init", expect.objectContaining({
                method: "POST",
    ...
    describe("Deep Link Tests", () => {
        ...
        it("should parse deep links correctly", async () => {
            await DeepLinkNow.initialize(testApiKey);
            const url = "https://deeplinknow.com/test/path?param1=value1&param2=value2";
